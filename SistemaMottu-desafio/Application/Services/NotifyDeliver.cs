...
{
    public class NotifyDeliver : INotify<MessageDeliver>
    {
...
#pragma warning disable CS8604
        ...
        public void NotifyMessage(MessageDeliver message)
        {
            var serialized = JsonSerializer.Serialize<MessageDeliver>(message);
